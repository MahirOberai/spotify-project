...
import trackDetails from './components/trackDetails/trackDetails.component';
import TrackDetails from './components/trackDetails/trackDetails.component';
  ...
  return (
    <div className="container">
      <form onSubmit={buttonClicked}>
          ...
          <Dropdown label="Playlist: " options={playlist.listOfPlaylistsFromAPI} selectedValue={playlist.selectedPlaylist} changed={playlistChanged}/>
